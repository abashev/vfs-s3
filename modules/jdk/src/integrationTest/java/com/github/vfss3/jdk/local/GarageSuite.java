...
/**
 * Runs every test in {@code com.github.vfss3.jdk.tests} against a freshly-started Garage
...
public class GarageSuite {
    ...
    static void startContainer() throws Exception {
        ...
        // Create a key with bucket-creation permission so JdkIntegrationContext can create the
