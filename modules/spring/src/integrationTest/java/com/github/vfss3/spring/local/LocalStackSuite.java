...
/**
 * Runs every test in {@code com.github.vfss3.spring.tests} against a freshly-started LocalStack
...
public class LocalStackSuite {
    ...
    static void startContainer() {
        ...
        SpringIntegrationContext.initialize(container.getEndpointOverride(S3), credentialsProvider);
    }
