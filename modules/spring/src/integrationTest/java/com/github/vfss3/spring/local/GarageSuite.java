...
/**
 * Runs every test in {@code com.github.vfss3.spring.tests} against a freshly-started Garage
 * container. Garage requires post-start bootstrap (layout assignment + S3 key creation) which is
 * done via {@code execInContainer}, mirroring {@code modules/commons-vfs}'s
 * {@code local.GarageSuite}.
 */
...
public class GarageSuite {
    ...
    static void startContainer() throws Exception {
        ...
        // Create a key with bucket-creation permission so SpringIntegrationContext can create the
