...
final class S3FileNameParserTest {
    ...
    void checkRegionParsing() throws FileSystemException {
        ...
        assertThat(parse("s3://bucket.s3.eu-west-1.amazonaws.com")).hasSigningRegion("eu-west-1");

        assertThat(parse("s3://s3-tests.storage.yandexcloud.net")).hasSigningRegion("ru-central1");

        assertThat(parse("s3://s3-tests.oss.aliyuncs.com")).hasSigningRegion("cn-hangzhou");
    }
